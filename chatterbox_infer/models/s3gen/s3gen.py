...
class S3Token2Mel(torch.nn.Module):
    ...
    def embed_ref(
        ...
        if ref_mels_24.shape[1] != 2 * ref_speech_tokens.shape[1]:
            # print("ref_mels_24.shape[1] : ", ref_mels_24.shape[1], ref_speech_tokens.shape[1], ref_mels_24.shape[1] // 2)
